...
class UrdfCapsuleTests(unittest.TestCase):
    def test_extracts_capsule_collisions_from_mjcf_body_tree(self):
        capsules = extract_capsules_from_mjcf(ROBOT_ROOT / "mjcf" / "astro_p1_30dof.xml")
    ...
    def test_adds_extension_capsules_to_matching_urdf_links(self):
        ...
        capsules = [extract_capsules_from_mjcf(ROBOT_ROOT / "mjcf" / "astro_p1_30dof.xml")[1]]
    ...
    def test_converts_current_astro_urdf_with_capsule_extension_tags(self):
        updated = convert_mjcf_capsules_to_urdf(ROBOT_ROOT / "urdf" / "astro_p1_30dof.urdf", ROBOT_ROOT / "mjcf" / "astro_p1_30dof.xml")
